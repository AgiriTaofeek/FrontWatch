...
// whole test run, not just this file — network.test.ts also imports
// from "./client", so this mock's shape has to be complete (both
// exports stubbed), or a run that executes this file first breaks the
// other one with a real "export not found" error. Found by running the
