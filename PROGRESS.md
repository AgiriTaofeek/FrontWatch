...
- [~] Release — **Postgres entity + control-api CRUD done**, release-health aggregation + dashboard not yet
  ...
  - [ ] Release-health aggregation (join `releases` against ClickHouse events where `release = version`: error/issue count, network failure rate, performance p75) + dashboard release list/detail — next chunk
